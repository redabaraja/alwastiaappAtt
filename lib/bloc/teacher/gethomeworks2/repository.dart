...
class GetHomeWorkRepo2 {
  Future<List<HomeWorkModel2>> getHomeWork(String token, String classID) async {
    List<HomeWorkModel2> data = [];
    Uri url;
    url = Uri.parse(getHomeWorkForStdApi);
    http.Response res =
    ...
    if (res.statusCode == 200) {
      ...
      for (var i = 0; i < d.length; i++) {
        data.add(HomeWorkModel2.fromMap(d[i]));
      }
    }
    return data;
  }
