...
import 'package:alwastia/screens/adsManager.dart';
...
class _ActiveClassesState extends State<ActiveClasses>
  ...
  //   _ad = BannerAd(
  //       size: AdSize.banner,
  //       adUnitId: AdsManager.adId,
  //       listener: AdsManager.bannerLisnter,
  //       request: AdRequest())
  //     ..load();
  // }
  ...
  void initState() {
    super.initState();
    // _createBannerAd();
    BlocProvider.of<GetClassesBloc>(context).add(GetMyClasses(status: '0'));
  }
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Container(
                            height: h * 0.1,
                            width: h * 0.1,
                            decoration: state.data[index].image.isEmpty
                                ? boxDecoration(
                                    radius: 5,
                                    imageExsit: true,
                                    boxfit: BoxFit.cover,
                    ...
                    if (state.res)
                      {
                        ...
                        setSheetState(() {
                          ...
                          showError = true;
                          errorString = 'تم إنشاء المقرر بنجاح';
                        })
                      }
                    else
                      {
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      buildTextField(
                          h, w, f, classnamecontroller, 'اسم المقرر', false),
                      Container(
                        height: h * 0.02,
                      ),
                      buildTextField2(
                          h, w, f, classdisccontroller, ',وصف المقرر', false),
                      Container(
                        height: h * 0.05,
                      ),
                      InkWell(
                          onTap: () {
                            ...
                            if (classnamecontroller.text.isEmpty) {
                              setSheetState(() {
                                showError = true;
                                errorString = "فضلا ادخل اسم المقرر";
                              });
                            } else if (classdisccontroller.text.isEmpty) {
                              setSheetState(() {
                                showError = true;
                                errorString = "فضلا ادخل وصف للمقرر";
                              });
                            } else
