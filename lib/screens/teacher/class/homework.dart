...
import 'package:alwastia/screens/teacher/class/students_homework.dart';
...
class _HomeWorkState extends State<HomeWork>
  ...
  void initState() {
    super.initState();
    BlocProvider.of<GetHomeWorkBloc>(context)
        .add(GetMyHomeWorks(classId: element.id));
  }
  ...
  Widget build(BuildContext context) {
    ...
    double f = w / 25;
    return SafeArea(
      child: BlocListener<GetHomeWorkBloc, GetHomeWorkState>(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  BlocBuilder<GetHomeWorkBloc, GetHomeWorkState>(
                                      ...
                                      Navigator.of(context).push(
                                          MaterialPageRoute(
                                              builder: (BuildContext context) =>
                                                  ClassStudentsHomeWork(
                                                      element: element,assignmentId: state.data[index].id,)));
                                      // setState(() {
  ...
  Material buttons(String txt, int click, Color color) {
    return Material(
      child: Container(
        ...
        child: BlocBuilder<CreateHomeWorkBloc, CreateHomeWorkState>(
            builder: (context, state) {
  ...
  Widget buildSheets(double height, double width, double fontx) {
    ...
    return FractionallySizedBox(
      ...
      child: StatefulBuilder(builder: (context, StateSetter setSheetState) {
        return BlocListener<CreateHomeWorkBloc, CreateHomeWorkState>(
          listener: (context, state) => {
            if (state is CreateHomeWorkDone)
              {
                if (state.connection)
                  {
                    if (state.res)
                      {
                        ...
                        setSheetState(() {
                          ...
                          showError = true;
                          errorString = 'تم اضافة الواجب بنجاح';
                        })
                      }
                    else
                      {
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      buildTextField(
                          h, w, f, titleccontroller, 'عنوان الواجب', false),
                      Container(
                        height: h * 0.02,
                      ),
                      buildTextField2(
                          h, w, f, contentcontroller, 'محتوى الواجب', false),
                      Container(
                        height: h * 0.02,
                      ),
                      InkWell(
                      ...
                      InkWell(
                          onTap: () {
                            ...
                            if (titleccontroller.text.isEmpty) {
                              ...
                              BlocProvider.of<CreateHomeWorkBloc>(context).add(
                                  CreateHomeWork(
  ...
  Widget choseDate(String dateString) {
    return Container(
      height: h * 0.07,
      width: w * 0.95,
      ...
      child: Center(
        child: Text(dateString,
            style: TextStyle(
                fontSize: f, fontWeight: FontWeight.bold, color: Colors.grey)),
      ),
    );
  }
