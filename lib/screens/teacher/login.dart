...
class TeacherLogin extends StatefulWidget {
  late bool isStd;
  TeacherLogin({required this.isStd});
  @override
  State<TeacherLogin> createState() => _TeacherLoginState(isStd: isStd);
}
...
class _TeacherLoginState extends State<TeacherLogin> {
  ...
  late bool isStd;
  _TeacherLoginState({required this.isStd});
              ...
              if (state.connection)
                {
                  if (state.res)
                  ...
                  else
                    {
                      setState(() {
                        showError = true;
                        errorString = 'اسم المستخدم او كلمة المرور غير صحيح';
                      })
                    }
                }
              else
                    ...
                    child: Column(
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            if (valdiation()) {
                              BlocProvider.of<LoginBloc>(context).add(Loginn(
                                  username: isStd
