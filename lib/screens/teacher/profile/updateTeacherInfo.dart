...
class UpdateTeacherInfo extends StatefulWidget {
  late TeacherModle data;
  UpdateTeacherInfo({required this.data});
  @override
  State<UpdateTeacherInfo> createState() => _UpdateTeacherInfoState(data: data);
}

class _UpdateTeacherInfoState extends State<UpdateTeacherInfo> {
  late TeacherModle data;
  _UpdateTeacherInfoState({required this.data});
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        // buildTextField(
                        //     h, w, f, degreecontroller, 'الشهادة والتخصص', false),
                        buildTextField(
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: BlocBuilder<UpdateUserInfoBloc,
                                UpdateUserInfoState>(builder: (context, state) {
